...
error_reporting(0);
 $output = '';  
 //$idd=$_GET['grpmem'];
 $sql = "SELECT *  FROM account WHERE Acc_type LIKE '%".$database->prep($_POST["search"])."%' AND  YEAR(DOE)='".$_GET["yr"]."'"; 
      ...
      echo $output;
	   ...
	   echo  $o= '  
                <tr id="">  
                     ...
                     <td><a class="btn btn-success" href="finance_year.php?tr='.$tr.'&yr='.$_GET['yr'].'">Print Report</a></td>
