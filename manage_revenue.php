...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6">
          <a class="btn btn-success" href="" data-toggle="modal" data-target="#manage_revenue"><span class="fa fa-user"></span> New Revenue</a>
        </div>
...
<div class="modal fade" id="manage_revenue">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">New Revenue</h4>
      </div>
      <div class="modal-body">
        <form method="post">
          <div class="form-group">
            <label for="name">Revenue Name*</label>
