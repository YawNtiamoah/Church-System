...
require 'includes/includes.php';  
 $output = '';  
 $sql = "SELECT * FROM users WHERE access_level = 'supervisor' AND full_name LIKE '%".$database->prep($_POST["search"])."%'"; 
          ...
          $sta = Station::find_by_id($row['station_id']);
           ...
           $output .= '  
                <tr id="'.$row['user_id'].'">  
                     ...
                     <td><a class="btn btn-success" href="station_manager.php?id='.$row["user_id"].'">View</a></td>
                </tr>  
           ';  
