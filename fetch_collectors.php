...
//manager details
 ...
 $output = '';  
 $sql = "SELECT * FROM users WHERE access_level = 'collector' AND station_id='".$manager['station_id']."' AND full_name LIKE '%".$database->prep($_POST["search"])."%'"; 
 ...
 {  
      ...
      {  
           ...
           //station details
          $sta = Station::find_by_id($row['station_id']);
           ...
           $output .= '  
                <tr id="'.$row['user_id'].'">  
                     ...
                     <td><a class="btn btn-success" href="collector.php?id='.$row["user_id"].'">View</a></td>
                </tr>  
           ';  
