...
<script>  
 ...
 <div class="container">
    <div class="row">
        ...
        <div class="col-md-6" align="right"> <form class="navbar-form navbar-left" action="fetch_year_expense.php" role="search">
                  <div class="form-group" align="right">
                    <input type="text" name="search_text" id="search_text" autofocus class="form-control" placeholder="Search For Expense ">
