...
error_reporting(0);
 $output = '';  
 //$idd=$_GET['grpmem'];
 $sql = "SELECT *  FROM account WHERE Acc_type LIKE '%".$database->prep($_POST["search"])."%' AND MONTH(DOE)='".$_GET["mn"]."' AND YEAR(DOE)='".$_GET["yr"]."'"; 
      ...
      echo $output;
	   ...
	   echo  $o= '  
                <tr id="">  
                     ...
                     <td><a class="btn btn-success" href="finance_month.php?tr='.$tr.'&mn='.$_GET['mon'].'&yr='.$_GET['yr'].'">Print Report</a></td>
