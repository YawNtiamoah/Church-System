...
require 'includes/includes.php'; 
 ...
 $output = '';  
 $sql = "SELECT * FROM transfer_tb WHERE Full_Name LIKE '%".$database->prep($_POST["search"])."%' OR Reason LIKE '%".$database->prep($_POST["search"])."%'  OR DOE LIKE '%".$database->prep($_POST["search"])."%' AND Status='1' "; 
