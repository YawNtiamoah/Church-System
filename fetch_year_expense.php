...
error_reporting(0);
 $output = '';  
 //$idd=$_GET['grpmem'];
 $sql = "SELECT *  FROM expense WHERE Reason LIKE '%".$database->prep($_POST["search"])."%'AND YEAR(DOE)='".$_GET["yr"]."'"; 
	   ...
	   echo  $o= '  
                <tr id="">  
                     ...
                     <td>Total Amount :</td>
                      ...
                      <td><a class="btn btn-success" href="expense_year.php?tr='.$tr.'&yr='.$_GET['yr'].'">Print Report</a></td>
