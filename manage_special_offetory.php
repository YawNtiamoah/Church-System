...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6">
          <a class="btn btn-success" href="" data-toggle="modal" data-target="#manage_offetory"><span class="fa fa-user"></span> New Special Offetory</a>
        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">New Special Offetory</h4>
      </div>
      <div class="modal-body">
        <form method="post">
            <div class="form-group">
            <label for="name">Type of Offetory:</label>
            <input type="text" class="form-control" id="name" placeholder="Enter Type of Offetory" name="txtDistrictName" required >
          </div>
          <div class="form-group">
