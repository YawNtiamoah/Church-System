...
require 'includes/includes.php'; 
 ...
 $output = '';  
 $sql = "SELECT * FROM membership WHERE Full_Name LIKE '%".$database->prep($_POST["search"])."%' OR First_Name LIKE '%".$database->prep($_POST["search"])."%'  OR Surname LIKE '%".$database->prep($_POST["search"])."%' AND Level_Married='1' AND Partner_Name !='' "; 
