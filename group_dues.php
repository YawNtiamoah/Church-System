...
*/
	...
	//}
		...
		$client->dp = $database->prep(trim($_POST['dp']));		
        $client->amt = $database->prep(trim($_POST['amt']));
		
		$result = $client->new_group_dues();
		if ($result) {
			$trr=$_POST['gid'];
			$success = "USER SAVED";
					...
					?>
				<script>
				window.location="manage_mem_group.php?grp=<?php echo $trr; ?>";
				</script>
				<?php
					}
...
<div class="row">
		    <br />
			  ...
			  <h3 align="center">Edit Group Member Dues</h3>
                <?php  } else{  ?>
             
			 <h3 align="center"> Group Member Dues</h3>
            <?php
			}
			?>
		    ...
		    <form method="post" enctype="multipart/form-data" class="col-md-6">
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" value="<?php echo $_GET['grp'];  ?>" id="title" placeholder="Title" name="gid" required >
			  </div>
              <div class="form-group">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
			    ...
			    <input type="text" class="form-control" value="" id="v_num" placeholder="Date Created" name="amt" required >
			  </div>
               <div class="form-group">
			    <label for="v_num">Date paid</label>
			    <input type="date" class="form-control" value="" id="v_num" placeholder="Date Created" name="dp" required >
			  </div>
<!--
              <div class="form-group">
