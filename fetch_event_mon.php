...
require 'layouts/top.php'; 
 ...
 $output = '';  
 $sql = "SELECT * FROM event_tb WHERE  MONTH(Start_Date)='".$_GET["mn"]."' AND YEAR(Start_Date)='".$_GET["yr"]."' "; 
      ...
      echo $output;
	    echo  $o= '  
                <tr id="">  
                     ...
                     <td><a class="btn btn-success" href="event_mon.php?tr='.$tr.'&mn='.$_GET['mn'].'&yr='.$_GET['yr'].'">Print Report</a></td>
