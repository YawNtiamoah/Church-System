      ...
      {  
           ...
           $output .= '  
                <tr id="'.$row['ID'].'">  
                     ...
                     <td><a class="btn btn-success" href="manage_list_group.php?grp='.$row["ID"].'&grpmem='.$row["Group"].'">View Members</a></td> <td><a class="btn btn-success" href="group_list_print.php?grp='.$row["Group"].'">Print Members</a></td></td>
                </tr>  
           ';  
