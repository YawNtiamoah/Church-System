...
require 'layouts/top.php'; 
 ...
 $output = '';  
 $sql = "SELECT * FROM membership WHERE converts='0' AND YEAR(DOR)='".$_GET["yr"]."' "; 
      ...
      echo $output;
	    echo  $o= '  
                <tr id="">  
                     ...
                     <td></td>
					  <td></td>
                     <td><a class="btn btn-success" href="member_year.php?tr='.$tr.'&mn='.$_GET['mn'].'&yr='.$_GET['yr'].'">Print Report</a></td>
