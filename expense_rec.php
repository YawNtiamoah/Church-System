	...
	//}
		...
		if ($result) {
			...
			$success = "USER SAVED";
					...
					?>
				<script>
				window.location="expense_rec.php";
				</script>
				<?php
					}
...
$details = expense::find_by_id($_GET['tr']);
                $member = $database->fetch_array($details);
			  ?>
<div class="row">
		    <br />
              <?php if(isset($_GET['edit'])){?>
			  <h3 align="center">Edit Expense Record</h3>
                <?php  } else{  ?>
             
  <h3 align="center">New Expense Record</h3>
            <?php
			}
			?>
