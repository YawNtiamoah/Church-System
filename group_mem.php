...
*/
		...
		$id=$_GET['grp'];
			$id2=$_GET['fn'];
$sql=mysql_query("SELECT * FROM group_mem WHERE Group_ID='$id' AND Full_Name='$id2'");
if(mysql_num_rows($sql)>0){
?>
<script>
alert("Sorry please you have already added this record to this Group : "+ <?php echo $id; ?>);
</script>

<?php
header("Location:manage_add_mem.php?grp=$id");
	}
		else{
	//new client code
	...
	//}
		...
		if ($result) {
			...
			$success = "USER SAVED";
					...
					?>
				<script>
				window.location="manage_add_mem.php?grp=<?php echo $trr; ?>";
				</script>
				<?php
					}
...
<div class="row">
		    <br />
			  ...
			  <h3 align="center">Edit Group Member</h3>
                <?php  } else{  ?>
             
			 <h3 align="center">New Group Member</h3>
            <?php
			}
			?>
