...
error_reporting(0);
 $output = '';  
 //$idd=$_GET['grpmem'];
 $sql = "SELECT *  FROM tithe WHERE Full_Name LIKE '%".$database->prep($_POST["search"])."%' OR DOE LIKE '%".$database->prep($_POST["search"])."%' OR Transaction_ID LIKE '%".$database->prep($_POST["search"])."%'"; 
      ...
      echo $output;
	   ...
	   echo  $o= '  
                <tr id="">  
                     ...
                     <td><a class="btn btn-success" href="tithe_all.php">Print Report</a></td>
