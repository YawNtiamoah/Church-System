...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6">
          <a class="btn btn-success" href="" data-toggle="modal" data-target="#manage_weekly_tithe"><span class="fa fa-user"></span> New Weekly Tithe</a>
        </div>
...
<div class="modal fade" id="manage_weekly_tithe">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">New Weekly Tithe</h4>
      </div>
      <div class="modal-body">
        <form method="post">
          <div class="form-group">
            <label for="name">Tithe Holder's Name*</label>
            <input type="text" class="form-control" id="name" placeholder="Enter Expenditures Name" name="txtDistrictName" required >
          </div>
            <div class="form-group">
