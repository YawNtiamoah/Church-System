...
error_reporting(0);
 $output = '';  
 //$idd=$_GET['grpmem'];
 $sql = "SELECT *  FROM welfare_benefits WHERE Reason LIKE '%".$database->prep($_POST["search"])."%' OR DOE LIKE '%".$database->prep($_POST["search"])."%' OR Full_Name LIKE '%".$database->prep($_POST["search"])."%'"; 
	   ...
	   echo  $o= '  
                <tr id="">  
                     ...
                     <td>Total Amount :</td>
                      ...
                      <td><a class="btn btn-success" href="benefits_all.php?tr='.$tr.'&yr='.$_GET['yr'].'">Print Report</a></td>
