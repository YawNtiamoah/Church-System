...
error_reporting(0);
 $output = '';  
 //$idd=$_GET['grpmem'];
 $sql = "SELECT *  FROM expense WHERE Reason LIKE '%".$database->prep($_POST["search"])."%' AND YEAR(DOE)='".$_GET["yr"]."' AND MONTH(DOE)='".$_GET["mn"]."'"; 
	   ...
	   echo  $o= '  
                <tr id="">  
                     ...
                     <td>Total Amount :</td>
                      ...
                      <td><a class="btn btn-success" href="expense_month.php?tr='.$tr.'&yr='.$_GET['yr'].'&mn='.$_GET['mn'].'">Print Report</a></td>
